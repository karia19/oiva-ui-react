...
var ImageGridLightBox = function (_a) {
    ...
    var _d = useState(false), pointer = _d[0], setPointer = _d[1];
    if (!mainSrc || mainSrc.length === 0) {
        return React.createElement("div", null, "No images to display");
    }
    ...
    var ImageItems = function (_a) {
        ...
        return (React.createElement("div", { key: images.length, className: columnCss },
            images.map(function (image) { return (React.createElement("img", { key: image.id, src: image.url, alt: image.name, style: { cursor: pointer ? 'pointer' : 'default' }, onClick: function () { return handleImageClick(image); } })); }),
