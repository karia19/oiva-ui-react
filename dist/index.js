...
var Modal = function (image) {
    return (React.createElement("div", null,
        ...
        React.createElement("img", { className: "modal-content", alt: image.image.alt, src: image.image.url })));
};

var Arrow = function (_a) {
    var direction = _a.direction, onClick = _a.onClick;
    var leftArrow = (React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: "white-arrow-left" },
        React.createElement("path", { d: "M16 8L8 12l8 4", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })));
    var rightArrow = (React.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: "white-arrow-right" },
    ...
    return (React.createElement("button", { type: "button", onClick: onClick, className: "arrow" },
        " ",
        arrowContent));
};
...
var ImageGridLightBox = function (_a) {
    ...
    var ImageItems = function (_a) {
        ...
        return (React.createElement("div", { key: images.length, className: columnCss },
            ...
            selectedImage && (React.createElement("div", { id: "myModal", className: "modal" },
                React.createElement("span", { className: "close", onClick: function () { return handleModalClose(); } }, "\u00D7"),
                React.createElement(Arrow, { direction: "left", onClick: function () { return moveLeftArrow(); } }),
                React.createElement(Arrow, { direction: "right", onClick: function () { return moveRightArrow(); } }),
                React.createElement(Modal, { image: selectedImage })))));
    };
    return (React.createElement("div", { className: "image-component" },
        React.createElement("div", { className: "row1" }, imageRows.map(function (row, rowIndex) { return (React.createElement(ImageItems, { key: rowIndex, images: row })); }))));
};

export { Button, ImageGrid, ImageGridLightBox as ImageGridModal };
